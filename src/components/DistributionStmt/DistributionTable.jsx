...
function DistributionTable({ distribution, onDeleteClick, onEditClick }) {
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-center table-auto">
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                        {distribution.length > 0 ? (
                            ...
                            <tr>
                                <td colSpan="12" className="p-4 text-center text-gray-500 dark:text-gray-400 text-sm sm:text-base">
