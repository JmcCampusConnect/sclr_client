                ...
                <div className="px-8 py-5">
                    <div className="rounded-xl bg-gray-50 dark:bg-gray-800/70 p-4 border border-gray-200 dark:border-gray-700 shadow-sm text-center">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            {application.department} • {application.semester}
                        </p>
                        {hasDistribution && (
                            <div className="mt-3 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                                <p className="text-amber-700 dark:text-amber-300 text-sm font-semibold">
                                    ⚠️ This student has distribution records in the current academic year
                                </p>
                                <p className="text-amber-600 dark:text-amber-400 text-xs mt-1">
                                    Deleting this application will not remove distribution records
                                </p>
                            </div>
                        )}
                    </div>
